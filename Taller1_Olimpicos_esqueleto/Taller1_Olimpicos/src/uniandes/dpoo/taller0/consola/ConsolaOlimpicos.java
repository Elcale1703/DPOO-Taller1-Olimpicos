...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("2. Consultar el Pais de un atleta");
		System.out.println("3. Consultar los atletas de un año dado");
		System.out.println("4. Consultar las medallas de un atleta en un periodo");
		System.out.println("5. Consultar los atletas de un país dado");
		System.out.println("6. Consultar el país con más medallistas");
		System.out.println("7. Consultar todos los medallistas de un evento dado");
		System.out.println("8. Consultar los atletas con un mínimo de medallas");
		System.out.println("9. Consultar el atleta estrella de todos los tiempos");
		System.out.println("10. Consultar mejor país en un evento");
		System.out.println("11. Consultar el atleta todoterreno");
		System.out.println("12. Consultar los medallistas por país y género");
		System.out.println("13. Consultar el porcentaje de atletas que son medallistas");
		System.out.println("14. Salir de la aplicación\n");
	}
	
	/**
	 * Muestra el pais de un atleta
	 */
	
	private void ejecutarAtletaPais()
	{
		System.out.println("\n" + "Pais de un Atleta" + "\n");

		String atleta = input("Por favor ingrese el nombre del Atleta");
		String atletas = calculadora.atletasPais(atleta);
		if (atletas == null)
		{
