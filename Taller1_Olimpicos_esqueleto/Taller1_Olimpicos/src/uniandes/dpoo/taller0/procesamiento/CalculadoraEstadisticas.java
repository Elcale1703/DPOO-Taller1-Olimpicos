...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Pasado el nombre, se busca si si esta en la lista
	 * 
	 * 
	 * @param Nombre a consultar el pais
	 * @return Se devuelve el nombre del atleta y su pais 
	 *         
	 */
	
	public String atletasPais(String nombreAtleta)
	{
		Atleta elAtleta = buscarAtleta(nombreAtleta);
		String resultado = null;
		if (elAtleta != null)
		{
			resultado = elAtleta.darNombre();
